...
export default function CardBlog(props: propsInterface) {
    ...
    return (
        <article className="flex flex-col bg-zinc-800 rounded-2xl shadow-lg w-48 h-96 py-4 px-1 md:w-56">
            ...
            <main className="basis-1/4 w-full h-auto">
                <h3 className="text-pretty text-md font-semibold text-primary overflow-hidden [display:-webkit-box] [-webkit-box-orient:vertical] [-webkit-line-clamp:3]">{title}</h3>
            </main>
