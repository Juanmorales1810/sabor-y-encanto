            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-secondary-500 font-medium">
                                ...
                                <li className="mb-4">
                                    <Link href="https://www.instagram.com/restaurant_sabor_y_encanto/profilecard/?igsh=MXFheWtraG9nZWw2cw==" className="hover:underline ">Instagram</Link>
                                </li>
                                <li>
                                    <Link href="https://www.facebook.com/share/1B7kxBYXQj/?mibextid=wwXIfr" className="hover:underline">Facebook</Link>
                                </li>
                            </ul>
                        </div>
                        <div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        <Link href="https://www.facebook.com/share/1B7kxBYXQj/?mibextid=wwXIfr" className="text-secondary-500 hover:text-gray-900 dark:hover:text-white">
                            <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                                <path fillRule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clipRule="evenodd" />
                            </svg>
                            <span className="sr-only">Facebook page</span>
                        </Link>
                        <Link href="https://www.instagram.com/restaurant_sabor_y_encanto/profilecard/?igsh=MXFheWtraG9nZWw2cw==" className="text-secondary-500 hover:text-gray-900 dark:hover:text-white ms-5">
