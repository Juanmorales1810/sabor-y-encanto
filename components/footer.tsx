            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-secondary-500 font-medium">
                                ...
                                <li className="mb-4">
                                    <Link href="https://www.instagram.com/restaurant_sabor_y_encanto/" className="hover:underline ">Instagram</Link>
                                </li>
                                <li>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        ...
                        <Link href="https://www.instagram.com/restaurant_sabor_y_encanto/" className="text-secondary-500 hover:text-gray-900 dark:hover:text-white ms-5">
